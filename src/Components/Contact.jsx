            ...
            <form action="" method="POST" className="xl:pl-10 2xl:pl-20">
                <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                    <div className="mb-4">
                        ...
                        <input type="text" name="name" id="name" autoComplete="name" required placeholder="Syon Chau" className="text-field" />
                    </div>
                    <div className="mb-4">
                        <label htmlFor="email" className="label">
                            Email
                        </label>
                        <input type="text" name="email" id="email" autoComplete="email" required placeholder="syonchau@example.com" className="text-field" />
                    </div>
                </div>
                <div className="mb-4">

        ...
        <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
            <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
                ...
                <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch] reveal-up">
                    Please feel free to reach out, so we could connect!
                </p>
            ...
            <form action="https://getform.io/f/alllgxwa" method="POST" className="xl:pl-10 2xl:pl-20">
                <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                    <div className="mb-4">
                        ...
                        <input type="text" name="name" id="name" autoComplete="name" required placeholder="Syon Chau" className="text-field reveal-up" />
                    </div>
                    <div className="mb-4">
                        <label htmlFor="email" className="label reveal-up">
                            Email
                        </label>
                        <input type="text" name="email" id="email" autoComplete="email" required placeholder="syonchau@example.com" className="text-field reveal-up" />
                    </div>
                </div>
                <div className="mb-4">

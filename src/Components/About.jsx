    ...
    >
        <div className="container">
            <div className="bg-zinc-800/50 p-7 rounded-2xl md:p-12 reveal-up">
                <p className="text-zinc-300 md:mb-8 md:text-xl md:max-w-[60ch]">
                Welcome! I&apos;m Syon, a professional web developer with a knack 
                ...
                <div className="flex flex-wrap items-center gap-4 md:gap-7">
                    ...
                    <img src="/images/logo-removebg-preview.png" alt="Logo" width = {30} height = {30} className="ml-auto md:w-[40px] md:h-[40px]" />
                </div>
            </div>
        </div>
    </section>
